...
logfile=/var/log/bobcoin-mining.log
...
echo "#############################################"
echo "##  bobcoin Ubuntu Build script v$version   ##"
echo "#############################################"
echo
echo "This will compile and install the key-components of the bobcoin Core, including a graphical wallet, and a mining script (should you choose to use that."
...
echo
echo "run bobcoin-qt, accept the defaults, then close it"
echo "run cp $DIR/bobcoin.conf ~/.bobcoin/"
echo "restart bobcoin-qt and the wallet should eventually sync"
echo "      / \----------------------------------, 
      \_,|        'Start a node'           | 
         |               ~                 |
         |    Sun Tzu, the art of crypto   |
         |  ,------------------------------|
