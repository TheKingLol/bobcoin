...
A number of changes to the way Bobcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 smallBob per kB (0.00001 BOB). This is to prepare for dropping the minimum transaction fee to 0.1 smallBob per kB (0.0001 BOB) in the next release.
