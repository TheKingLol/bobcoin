...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bobcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bobcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bobcoin transaction") + "\n" +
              "  bobcoin-tx [options] -create [commands]   " + _("Create hex-encoded bobcoin transaction") + "\n" +
              "\n";
