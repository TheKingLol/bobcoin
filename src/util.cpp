...
const char * const BITCOIN_CONF_FILENAME = "bobcoin.conf";
const char * const BITCOIN_PID_FILENAME = "bobcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bobcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bobcoin";
#else
    // Unix
    return pathRet / ".bobcoin";
#endif
#endif
}
