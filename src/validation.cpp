...
#if defined(NDEBUG)
# error "Bobcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bobcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BOB additional fees, %d delta bytes\n",
